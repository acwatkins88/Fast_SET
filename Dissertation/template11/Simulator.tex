...
\[
\begin{gathered}
\hbox to 1in{\includegraphics[width=1in]{ch3-square.eps}}
\quad
\hbox to 1in{\includegraphics[width=1in]{ch3-circle.eps}} \\
...
\[
\begin{gathered}
\hbox to 1in{\includegraphics[width=1in]{ch3-triangle.eps}}\\
...
\hbox to 1in{\includegraphics[width=1in]{ch3-square.eps}}
  \quad
\hbox to 1in{\includegraphics[width=1in]{ch3-square.eps}}\\[-10pt]
...
\hbox to 1in{\includegraphics[width=1in]{ch3-circle.eps}}
  \quad
\hbox to 1in{\includegraphics[width=1in]{ch3-circle.eps}}\\[-10pt]
...
\hbox to 1in{\includegraphics[width=1in]{ch3-triangle.eps}}
  \quad
\hbox to 1in{\includegraphics[width=1in]{ch3-triangle.eps}}\\[-10pt]
