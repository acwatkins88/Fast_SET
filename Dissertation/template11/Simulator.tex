...
To consider the MET case, multiple pulses are randomly inserted. As discussed in \cite{Ebrahimi2016}, layout information is important in accurately modeling the location of the MET for a real design. Gates that are near each other in a netlist may not necessarily be close in the layout. In this section, for the sake of simplicity, only 2 pulses are generated in gates that are close by in the net list. However, for the sake of simple comparison and analysis, using the netlist is not problematic. 